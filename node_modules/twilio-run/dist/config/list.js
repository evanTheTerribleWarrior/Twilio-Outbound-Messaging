...
function getConfigFromFlags(flags, externalCliOptions) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        flags.cwd = cwd;
        const configFlags = global_1.readSpecializedConfig(cwd, flags.config, 'list', {
        ...
        const serviceSid = flags.serviceSid ||
            (yield utils_1.getFunctionServiceSid(cwd, flags.config, 'list', ((_a = flags.username) === null || _a === void 0 ? void 0 : _a.startsWith('AC')) ? flags.username
        ...
        return {
            ...
            edge,
            outputFormat,
            userAgentExtensions: userAgentExtensions_1.getUserAgentExtensions('list', externalCliOptions),
        };
    });
}
