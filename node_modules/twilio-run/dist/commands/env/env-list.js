...
const debug = logger_1.getDebugFunction('twilio-run:env:get');
...
function handler(flags, externalCliOptions) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield legacy_config_1.default(flags.cwd, false);
        let config;
        try {
            config = yield env_list_1.getConfigFromFlags(flags, externalCliOptions);
        }
        catch (err) {
            debug(err);
            logger_1.logger.error(err.message);
        ...
        try {
            ...
            const result = yield client.getEnvironmentVariables(config);
            env_list_2.outputVariables(result, flags.outputFormat);
        }
        catch (err) {
            handleError(err);
        }
...
exports.cliInfo = {
    options: Object.assign({}, flags_1.getRelevantFlags([
