...
const debug = logger_1.getDebugFunction('twilio-run:env:unset');
...
function handler(flags, externalCliOptions) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let config;
        try {
            config = yield env_import_1.getConfigFromFlags(flags, externalCliOptions);
        }
        catch (err) {
            debug(err);
            logger_1.logger.error(err.message);
        ...
        try {
            ...
            yield client.setEnvironmentVariables(config);
