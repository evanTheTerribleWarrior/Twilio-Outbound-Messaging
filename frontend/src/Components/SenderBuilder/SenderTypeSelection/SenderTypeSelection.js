...
const SenderTypeSelection = () => {
	...
	const [radioSelection, setRadioSelection] = useState(senderTypeSelection)
    ...
    return (
		<Box mt={2}>
          <RadioGroup aria-label="sender" name="sender" value={radioSelection} onChange={onRadioChange} row>
