...
const MessageTypeSelection = () => {
	...
	const [radioSelection, setRadioSelection] = useState(messageTypeSelection)
    ...
    return (
		<Box mt={2}>
          <RadioGroup aria-label="message" name="message" value={radioSelection} onChange={onRadioChange} row>
